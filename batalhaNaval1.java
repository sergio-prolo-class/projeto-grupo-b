...
// }
    ...
    if (args[0].equals("G")) {
        ...
        // lerTabuleiro();
        // validarTabuleiro();
    else if (args [0].equals("help")) { System.out.println("Ao entrar com G, este programa gera um tabuleiro de batalha naval, caso entre com V, ele valida o seu tabuleiro de entrada"); } 
